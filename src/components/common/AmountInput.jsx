    ...
    <div className={`flex flex-col gap-1.5 ${wrapperClassName}`}>
      ...
      <div className="relative flex items-center">
        ...
        <input
          ...
          className={`w-full text-sm font-medium rounded-xl border bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 pl-8 pr-3.5 py-2 transition-colors placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-[#2845D6]/30 focus:border-[#2845D6] disabled:bg-slate-100 dark:disabled:bg-slate-900 disabled:cursor-not-allowed ${
            error
