...
class PartnerDeviceAuthController extends Controller
{
    ...
    public function start(Request $request): JsonResponse
    {
        ...
        $result = $this->deviceAuthService->startVerification(
            ...
            appType: 'restaurant_partner',
            deviceName: $validated['device_name'] ?? 'Partner Device',
    ...
    public function verify(Request $request): JsonResponse
    {
        ...
        $result = $this->deviceAuthService->verifyOtp(
            ...
            deviceName: $validated['device_name'] ?? 'Restaurant Partner App'
        );
    ...
    public function changeDevice(Request $request): JsonResponse
    {
        ...
        $this->deviceAuthService->changeDevice(
            ...
            deviceId: $validated['device_id'],
            appType: 'restaurant_partner',
            reason: 'PARTNER_DEVICE_CHANGED'
        );

        return ApiResponse::success(null, 'Partner device session removed. You can now verify on this or a new device.');
    }
