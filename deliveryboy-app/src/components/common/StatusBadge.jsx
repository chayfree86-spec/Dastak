...
export const StatusBadge = ({ status, size = 'sm' }) => {
  ...
  return (
    <span
      className={`inline-flex items-center font-extrabold tracking-wider rounded-xl border uppercase select-none ${current.bg} ${current.text} ${current.border} ${sizeClasses[size] || sizeClasses.sm}`}
    >
