...
const DISMISS_KEY = 'dastak_delivery_pwa_dismissed_until';
const INSTALLED_KEY = 'dastak_delivery_pwa_installed';
...
export function usePwaInstall() {
  ...
  const promptInstall = useCallback(async () => {
    ...
    try {
      ...
      console.error('[PWA] Delivery rider install prompt error:', err);
    }
    return false;
  }, [deferredPrompt]);
