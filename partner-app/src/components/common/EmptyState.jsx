...
import { Inbox, ShoppingBag, UtensilsCrossed, RefreshCw, AlertCircle } from 'lucide-react'
...
export const EmptyState = ({
  ...
  return (
    <div className={`p-8 sm:p-12 rounded-3xl bg-white dark:bg-slate-800 border border-slate-200/80 dark:border-slate-700 text-center flex flex-col items-center justify-center gap-3 ${className}`}>
...
export const ErrorState = ({
  ...
  return (
    <div className={`p-6 sm:p-10 rounded-3xl bg-rose-50/50 dark:bg-rose-950/20 border border-rose-200 dark:border-rose-800/40 text-center flex flex-col items-center justify-center gap-3 ${className}`}>
