      ...
      <div
        ...
        className={`relative border-2 border-dashed rounded-2xl p-4 flex flex-col items-center justify-center text-center cursor-pointer transition-all ${
          previewUrl
            ...
            : 'border-slate-200 dark:border-slate-700 hover:border-[#113BD0] dark:hover:border-blue-500 bg-slate-50/30 dark:bg-slate-900/60 hover:bg-blue-50/20 dark:hover:bg-slate-800'
        ...
        {previewUrl ? (
          ...
          <div className="space-y-1.5 py-2">
            ...
            <p className="text-xs font-bold text-slate-700 dark:text-slate-200">
              Click to browse <span className="text-[#113BD0] dark:text-blue-400 font-bold">image</span>
            </p>
