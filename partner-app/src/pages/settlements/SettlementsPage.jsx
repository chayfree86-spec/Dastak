        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-3 items-center">
          ...
          <div className="md:col-span-6 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-slate-50 dark:bg-slate-750 border border-slate-200 dark:border-slate-700 rounded-2xl text-xs font-semibold text-slate-800 dark:text-slate-200 placeholder-slate-400 focus:outline-none focus:border-[#2845D6] focus:ring-2 focus:ring-blue-500/20"
            />
          </div>
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-4 w-full sm:w-auto justify-between sm:justify-end border-t sm:border-t-0 pt-3 sm:pt-0 border-slate-100 dark:border-slate-700">
                ...
                <div className="w-8 h-8 rounded-full bg-slate-50 dark:bg-slate-750 group-hover:bg-[#2845D6] group-hover:text-white dark:group-hover:bg-blue-600 text-slate-400 flex items-center justify-center transition-all shrink-0">
